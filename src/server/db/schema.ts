...
import { index, primaryKey, sqliteTableCreator, text, integer, real, } from "drizzle-orm/sqlite-core";
 ...
 */
export const createTable = sqliteTableCreator((name) => `firesubz_${name}`);
